        ...
        >
          ...
          >
            <Stack spacing={3} alignItems={{ xs: 'center', md: 'flex-start' }} textAlign={{ xs: 'center', md: 'left' }}>
              ...
              <Typography variant="h6" color="text.primary">
               Interested in seeing if there are other photos of a particular statue? Upload a photo and
                search for other photos of the statue in the KSP&apos;s database. Our trained image recognition model will return
